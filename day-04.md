...
- When a function is called, a block is created in the stack, when another function is called, the current function execution is paused ad a new block is created on top of the old block. This continues until the last function call.
